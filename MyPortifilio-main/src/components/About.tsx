  ...
  const experiences = [
    {
      ...
      title: "Front-End Developer - ICTMISR",
      description: "Develop and maintain scalable React.js applications with TypeScript, Redux, and Tailwind CSS. Collaborate with backend engineers to integrate REST APIs and improve application performance.",
      location: "Cairo, Egypt"
    },
    {
      year: "2024 - 2025",
      title: "Full-Stack Developer - AgroMind Graduation Project",
      description: "Led development of AI-powered agricultural management platform serving farmers and agricultural experts. Architected full-stack solution using React.js, ASP.NET Core, and SQL Server with AI integration for smart farming recommendations.",
