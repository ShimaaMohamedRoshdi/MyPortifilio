...
import img8 from "../assets/images/Weatherappimage.png";
...
import creditScoreImg from "../assets/images/CreditScore.png"; 
import graduationProjectImg from "../assets/images/graduationproject.png"; 
  ...
  const projects = [
    {
      ...
      {
      id: 20,
      title: "AgroMind: Smart Farming with AI",
      description: "AI-powered agricultural management platform transforming traditional farming into smart, data-driven experience. Empowers farmers and agricultural experts with centralized ecosystem for managing land, tracking crops, and making informed decisions through seamless web interface.",
      image: graduationProjectImg,
      github: "https://github.com/ShimaaMohamedRoshdi/AgroMind-GradProj",
      demo: "https://drive.google.com/file/d/1e9oJ7TD62KP9GRx5rzRttGZRtmGiGout/view?usp=drive_link",
      tech: ["React.js", "Bootstrap", "ASP.NET Core", "SQL Server", "JWT", "RESTful APIs", "Postman", "Git", "AI", "Machine Learning"]
    },
  
    {
      ...
      {
      id: 14,
      title: "Credit Score Loan Assessment System",
      description: "A comprehensive full-stack application for evaluating loan applications using automated scoring algorithms. Features include configurable scoring variables, intelligent decision-making, user authentication, admin dashboard, and real-time application tracking. Built with modern technologies to streamline loan evaluation processes for financial institutions.",
      image: creditScoreImg,
      github: "https://github.com/ShimaaMohamedRoshdi/Scoring_Card",
      demo: "https://scoring-card-1.onrender.com/",
      tech: ["React", "Node.js", "NestJS", "PostgreSQL", "Prisma", "TypeScript", "JWT", "Swagger"]
    },
    {
      id: 12,
